...
Most of these scripts use MATLAB 2021b, unless otherwise specified. PsychToolbox is required for the program scripts. The Global Optimization Toolbox addon for MATLAB is necessary for the computational models.These scripts were run on a PC running 64-bin Windows 10 Enterprise with an Intel(R) Core(TN) i5-6500 CPU @ 3.20GHz and 8.00GB of Ram. 
