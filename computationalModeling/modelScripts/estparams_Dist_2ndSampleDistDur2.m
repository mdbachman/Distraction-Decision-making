...
% load the gaze data to find the first Fix
...
savefile = fullfile(dir,'results',...
    ['output_', num2str(s) cond num2str(grp) 'Data_2ndSampleDistDur2.mat']);
...
for i = 1:size(possparams,1)
    gridchisq_all(i) = fitFcn_Dist_2ndSampleDistDur2(vals, realchoices, realrts, distonset, distoffset, drate, ndt, boundary, nsims, ...
...
[estparams_all, chisq_all, exitflag_all, output_all, population_all, scores_all] = ...
    ga(@(params)(fitFcn_Dist_2ndSampleDistDur2(vals, realchoices, realrts, distonset, distoffset, drate,ndt, boundary, nsims, params,gaze,preDistLength,distLength,firstFixDur)), ...
